    ...
    "paths": {
        ...
        "/apkInstalled/uninstalledApkInstalled": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 0,\"message\": \"uninstalled Success\",\"result\": {},\"type\": \"success\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/appCategory/deleteApplicationCategory/{id}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 0,\"message\": \"delete Success\",\"result\": {},\"type\": \"success\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/appCategory/updateApplicationCategory/{id}": {
            "put": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "{\"code\": 7,\"message\": \"Data Conflict\",\"result\": {},\"type\": \"fail\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/appParamVar/createAppParamVar": {
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "{\"code\": 7,\"message\": \"conflict data\",\"result\": {},\"type\": \"fail\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/appPushTemplate/saveParameterTemplate": {
            "put": {
                ...
                "responses": {
                    ...
                    "404": {
                        "description": "{\"code\": 7,\"message\": \"Data not found\",\"result\": {},\"type\": \"fail\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/application/deleteDataFile/{id}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 0,\"message\": \"DeleteSuccess\",\"result\": {},\"type\": \"success\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/authority/getAuthorityList": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "paging role list,return includes list,total,page number,Quantity per page",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/base/captcha": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "generate code,return includes random number id,base64,code length",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/menu/getMenuList": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "paging base menu list,return includes list,total,page number,Quantity per page",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/merchant/updateMerchantStatus/{id}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 0,\"message\": \"UpdateSuccess\",\"result\": {},\"type\": \"success\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/model/exportModelExcel": {
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "{\"code\": 7,\"message\": \"data excel fail\",\"result\": {},\"type\": \"fail\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    }
        ...
        "/organization/createOrganization": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "{\"code\": 0,\"message\": \"CreateSuccess\",\"result\": {},\"type\": \"success\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
                    ...
                    "409": {
                        "description": "{\"code\": 7,\"message\": \"Conflict fields\",\"result\": {},\"type\": \"fail\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/organization/deleteOrganization/{id}": {
            "delete": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "{\"code\": 7,\"message\": \"deleteConflict\",\"result\": {},\"type\": \"fail\"}",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/sysOperationRecord/getSysOperationRecordList": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "pagingSysOperationRecordList,return includes list,total,page number,Quantity per page",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
    ...
    "definitions": {
        "config.AppConfig": {
            ...
            "properties": {
                ...
                "screenShotLimit": {
                    "description": "VersionNumberLimit int   ` + "`" + `mapstructure:\"version-number-limit\" json:\"versionNumberLimit\" yaml:\"version-number-limit\"` + "`" + `",
                    "type": "integer"
                },
                "tidCountNumber": {
                    "type": "integer"
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "local": {
                    "description": "Pgsql  Pgsql ` + "`" + `mapstructure:\"pgsql\" json:\"pgsql\" yaml:\"pgsql\"` + "`" + `\nDBList []DB  ` + "`" + `mapstructure:\"db-list\" json:\"db-list\" yaml:\"db-list\"` + "`" + `\noss",
                    "allOf": [
                        {
        ...
        "config.System": {
            ...
            "properties": {
                ...
                "addr": {
                    "description": "Addr                    int    ` + "`" + `mapstructure:\"addr\" json:\"addr\" yaml:\"addr\"` + "`" + `",
                    "type": "string"
                },
                "backendPath": {
                    "type": "string"
        ...
        "request.ApplicationUpdateDTO": {
            ...
            "properties": {
                ...
                "screenShot": {
                    "description": "ParseDataFiles  []ParseDataFile ` + "`" + `json:\"dataFiles,omitempty\" form:\"dataFiles\"` + "`" + `\nParseParametersFile []ParametersFile     ` + "`" + `json:\"parametersFile\" form:\"parametersFile\"` + "`" + `",
                    "type": "array",
                    "items": {
        ...
        "request.SavePushTaskSchemaGroup": {
            ...
            "properties": {
                ...
                "pushAppTaskID": {
                    "description": "AppPushTaskUUID string ` + "`" + `json:\"pushTaskAppUUID\" form:\"pushTaskAppUUID\" binding:\"required\"` + "`" + `",
                    "type": "integer"
                },
                "schemaP": {
                    "$ref": "#/definitions/tms.ParameterTemplateSchema"
        ...
        "tms.APKInstallDTO": {
            ...
            "properties": {
                ...
                "status": {
                    "description": "status pending if Admin commit to uninstall this app but terminal not install it yet",
                    "type": "string"
                },
                "storageUsage": {
                    "type": "integer"
        ...
        "tms.OrganizationDTO": {
            ...
            "properties": {
                ...
                "postalCode": {
                    "description": "binding:\"postcode_iso3166_alpha2=GB\"  //TODO: Validate postal code if not empty",
                    "type": "string"
                }
            }
        },
